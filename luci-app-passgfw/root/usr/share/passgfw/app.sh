...
TMP_DNSMASQ_PATH=/tmp/dnsmasq.d/passgfw
...
lua_api() {
	...
	echo $(lua -e "local api = require 'luci.model.cbi.passgfw.api.api' print(api.${func})")
}
...
run_global() {
	...
	source $APP_PATH/helper_dnsmasq.sh add TMP_DNSMASQ_PATH=$TMP_DNSMASQ_PATH DNSMASQ_CONF_FILE=/tmp/dnsmasq.d/dnsmasq-passgfw.conf DEFAULT_DNS=$DEFAULT_DNS TUN_DNS=$TUN_DNS
